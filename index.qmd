...
#| echo: false
#| fig-cap: "Anxiety vs Stress Survey with fitted regression line and 95% CI"
...
#| echo: false
#| fig-cap: "Anxiety vs Time with fitted regression line and 95% CI"
# Scatter plot with regression line using ggplot2
...
I would expect to see from the popular press a title similar to: "Get Off Social Media Now! Research Shows That Time on Social Media Has a Direct Relationship with Anxiety and Stress!" Or even claiming that stress + time on social media causes anxiety. I chose this title because news outlets often use titles that are misleading about the studies to gain initial attention.
